...
<tr>
    ...
    <td>
    <input type="text" name="personaje2" id="personaje2" <%=p2.getNombre() %>  />
    </td>
</tr>
<tr>
	<td>
    ...
    <td>
    <input type="text" name="vida1" id="vida1" value=<%=p1.getVida() %> />
    </td>
    <td></td>
    <td></td>
    <td>
...
<tr>
    ...
    <td></td>
    <td><input type="submit" name="action" id="atacar" value="Atacar"/></td>
    <td><input type="submit" name="action" id="defender" value="Defender" /></td>
</tr>
 </table>
</div>
</form>
